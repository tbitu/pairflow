...
export async function emitActorProtocolFromWorkspace(
  ...
  return { ...result, _meta: { bubbleId: resolvedInput.authoritativeContext.bubble_id, repo: resolvedInput.authoritativeContext.repo, originatingRole: resolvedInput.authoritativeContext.expected_role } };
}
